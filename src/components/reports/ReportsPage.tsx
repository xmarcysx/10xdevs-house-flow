      ...
      <div className="relative z-10 p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent mb-4">
            Raporty House<span className="text-blue-600 dark:text-blue-400">Flow</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            Przeglądaj swoje dane finansowe w przystępnej formie i zdobywaj cenne insights.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <a
              ...
              className="group block bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-800 dark:to-blue-900/20 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-0 overflow-hidden"
            >
              <div className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-medium">Szczegółowy przegląd wydatków</p>
                  </div>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6">
                  Przeglądaj swoje wydatki z podziałem na kategorie. Wybierz dowolny miesiąc i zobacz, na co wydajesz
                  najwięcej pieniędzy. Eksportuj dane do pliku CSV.
                </p>
            ...
            <a
              href="/reports/goals"
              className="group block bg-gradient-to-br from-white to-green-50/50 dark:from-gray-800 dark:to-green-900/20 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-0 overflow-hidden"
            >
              <div className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-medium">Śledź postęp swoich celów</p>
                  </div>
                </div>
                <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6">
