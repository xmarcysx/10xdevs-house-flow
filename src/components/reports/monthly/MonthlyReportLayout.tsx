...
interface MonthlyReportLayoutProps {
  children: React.ReactNode;
}

const MonthlyReportLayout: React.FC<MonthlyReportLayoutProps> = ({ children }) => {
  return (
      ...
      <div className="relative z-10 p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent mb-4">
            Raporty miesięczne House<span className="text-blue-600 dark:text-blue-400">Flow</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            Szczegółowe analizy wydatków i dochodów z podziałem na miesiące.
          </p>
        </div>
